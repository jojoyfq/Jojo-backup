...
public sendEmail() {}    
    ...
    public static boolean run(String addressedTo, String subject, String content) {
        ...
        String fromAddress = "merlionbank.no.reply@gmail.com";
        String smtpHost = "smtp.gmail.com"; // set the mailbox to send from 
        int smtpPort = 587; // set port
        String username = "merlionbank.no.reply@gmail.com"; // mailbox address
        String password = "yangyangzuishuai"; // *password*
