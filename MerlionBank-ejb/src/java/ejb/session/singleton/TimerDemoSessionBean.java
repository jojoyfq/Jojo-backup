...
public class TimerDemoSessionBean implements TimerDemoSessionBeanLocal {
    ...
    public void createTimers(Date startTime) {
        ...
        Timer fixedDepositAccountTimer = timerService.createTimer(startTime, 5 * 60 * 60 * 1000, "FixedDeposit-TIMER");
        System.err.println("********** FixedDeposit-TIMER TIMER CREATED");
    
        Timer accountClosureTimer = timerService.createTimer(startTime, 5 * 60 * 60 * 1000, "OnlineBankingAccount-TIMER");
